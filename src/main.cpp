...
static const int64 nTargetTimespan = 1 * 12 * 60 * 60; // Cagecoin: 0.5 Days
static const int64 nTargetSpacing = 120; // Cagecoin: 2 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1390608571; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1390608571;
            block.nNonce   = 975074;
        }
